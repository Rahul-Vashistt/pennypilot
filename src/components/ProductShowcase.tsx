export default function ProductShowcase() {
  return (
    <section className="px-4 sm:px-6 lg:px-8 py-10">
      <div className="mx-auto max-w-6xl overflow-hidden rounded-2xl border border-slate-200 bg-slate-100/60 shadow-2xl dark:border-slate-800 dark:bg-slate-900/50">
